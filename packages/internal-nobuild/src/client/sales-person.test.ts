...
import { lookUpSalesPersonForZipcode } from "./sales-person.ts";
  ...
  describe("lookUpSalesPersonForZipcode", () => {
    const salesPersons: SalesPersonDirectory = [
      ...
      },
      {
        ...
        email: "philippe@gospel.com",
      },
      {
        name: "lance",
        email: "lance@gospel.com",
        zipcodes: [
          "76",
          "27",
          "78",
